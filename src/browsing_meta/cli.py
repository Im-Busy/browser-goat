"""CLI entry point for browsing-meta.

Usage:
    browsing-meta search "What is Python?" --searxng-url http://localhost:8080
    browsing-meta search "latest AI news" --time-range week --strategy explore
    browsing-meta search "Python vs Rust" --reliability high
    uvx browsing-meta search "quantum computing research"
"""
