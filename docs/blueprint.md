# Browsing-Meta — Product Blueprint
...
**Browsing-Meta closes every gap** by wrapping SearXNG with six processing layers, each porting innovations from battle-tested open-source projects.

---

## 2. Product Vision

**Browsing-Meta** is a Python meta-layer that wraps SearXNG and makes it competitive with Tavily and Exa for AI agent use. It does NOT replace SearXNG — it augments it.
...
```
                         ...
                         └────────┬─────────┘
                                  ...
                                  ▼
┌─────────────────────────────────────────────────────────────────────┐
│                     BROWSING-META ROUTER                             │
│                     BrowsingMeta.search(query)                       │
└─────────────────────────────────────────────────────────────────────┘
         │           │           │           │           │
         ▼           ▼           ▼           ▼           ▼
┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐
...
Every module in Browsing-Meta traces back to a specific source. This is the lineage table:

### Phase 1 Sources

| Browsing-Meta Module | Source Repo | Source File | Lines | Innovation |
|---|---|---|---|---|
...
| Browsing-Meta Module | Source Repo | Source File | Innovation |
|---|---|---|---|
...
browsing-meta/
├── src/browsing_meta/
│   ├── __init__.py              # Package init, exports BrowsingMeta
│   ├── router.py                # Main orchestrator: BrowsingMeta.search()
